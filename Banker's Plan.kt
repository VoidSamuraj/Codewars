package banker
/*
ohn has some amount of money of which he wants to deposit a part f0 to the bank at the beginning of year 1. He wants to withdraw each year for his living an amount c0.
...
fun fortune(f0:Int, p:Double, c0:Int, n:Int, i:Double):Boolean {
    ...
    val inflation =i/100
    for(i in 1..n-1){
        moneyNow+=Math.floor(moneyNow*percent-toWithdraw).toInt()
        toWithdraw+=Math.floor(toWithdraw*inflation).toInt()
    }
    return moneyNow>=0
}
